...
famscripts.common = {
    ...
    lightGallery: function() {
        var e = $(".gallery-grid-tiles ul li").length;
        window.matchMedia("(min-width: 768px)").matches ? (e < 3 && e >= 2 && ($(".gallery-grid-tiles ul li:first-child").addClass("full-width"), $(".gallery-grid-tiles ul li:nth-child(2)").addClass("u-hidden")), e < 5 && e >= 3 && ($(".gallery-grid-tiles").addClass("tri-layout"), $(".gallery-grid-tiles ul li:first-child").addClass("quarter-width"), $(".gallery-grid-tiles ul li:nth-child(2),.gallery-grid-tiles ul li:nth-child(3)").addClass("half-width"), $(".gallery-grid-tiles ul li:nth-child(4)").addClass("fixed-tile half-width"), $(".gallery-grid-tiles ul li:nth-child(4) .info").append('<span  class="t-Button t-Button--icon t-Button--iconLeft info">\n                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: currentcolor;"><path d="m3 11.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z" fill-rule="evenodd"></path></svg>\n                Show All Photos</span>')), e > 5 && $(".gallery-grid-tiles ul li:nth-child(5) .info").append('<span  class="t-Button t-Button--icon t-Button--iconLeft info">\n        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: currentcolor;"><path d="m3 11.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z" fill-rule="evenodd"></path></svg>\n        Show All Photos</span>')) : $(".gallery-grid-tiles ul li:first-child .info").append('<span  class="t-Button t-Button--icon t-Button--iconLeft info">\n            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: currentcolor;"><path d="m3 11.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-10-5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z" fill-rule="evenodd"></path></svg>\n            Show All Photos</span>');
        let t = "",
            l = !1;
        const o = document.querySelector(".gallery-bg").querySelectorAll(".imgGallery"),
            r = document.getElementsByClassName("modalpage-content")[0];
        document.querySelector(".gallery-bg").querySelectorAll(".info").forEach((e => {
            e.addEventListener("click", (e => {
                e.preventDefault(), !1 === l && (o.forEach(((e, l) => {
                    t += '<div class="modalPageSlides ' + ((l + 1) % 3 == 1 ? "grids" : "") + `" onclick="famscripts.common.openLightBox(${l})"><img src="` + e.getAttribute("data-path") + '" class="imgActive"></div>'
                })), r.innerHTML = t, l = !0), document.querySelector(".gallery-bg .modalPage").style.display = "block", document.getElementsByTagName("html")[0].style.overflow = "hidden"
            }))
        })), document.querySelector(".close-modal-page").addEventListener("click", (() => {
            document.querySelector(".gallery-bg .modalPage").style.display = "none", document.getElementsByTagName("html")[0].style.overflow = "initial"
        }))
    },
    floorplan: function() {
        let e = "";
